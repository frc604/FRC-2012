...
public class ProcessSpeedProviderPidOnly implements SpeedProvider {
    ...
    private final ProcessSpeedProviderPidOnly.DifferentialOutput diffOutput;
    ...
    public ProcessSpeedProviderPidOnly (double P, double I, double D, PIDSource source, PIDOutput output) {
        this(P, I, D, 0, source, output);
    }
    public ProcessSpeedProviderPidOnly (double P, double I, double D, double DP, PIDSource source, PIDOutput output) {
        this.source = source;
        this.output = output;
        this.diffOutput = new ProcessSpeedProviderPidOnly.DifferentialOutput(this.output);
