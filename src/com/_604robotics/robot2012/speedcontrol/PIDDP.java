 ...
 */
public class PIDDP implements IUtility {
    ...
    private class PIDTask extends TimerTask {
        ...
        private PIDDP m_controller;

        public PIDTask(PIDDP controller) {
            if (controller == null) {
    ...
    /**
     * Allocate a PID object with the given constants for P, I, D, DP
     * @param Kp the proportional coefficient
     * @param Ki the integral coefficient
     * @param Kd the derivative coefficient
     * @param Kdp the derivative/position coefficient
     * @param source The PIDSource object that is used to get values
     * @param output The PIDOutput object that is set to the output value
     * @param period the loop time for doing calculations. This particularly effects calculations of the
     * integral and differential terms. The default is 50ms.
     */
    public PIDDP(double Kp, double Ki, double Kd, double Kdp,
        ...
        m_controlLoop.schedule(new PIDDP.PIDTask(this), 0L, (long) (m_period * 1000));
    }

    /**
     * Allocate a PID object with the given constants for P, I, D, DP, using a 50ms period.
     * @param Kp the proportional coefficient
     * @param Ki the integral coefficient
     * @param Kd the derivative coefficient
     * @param Kdp the derivative/position coefficient
    ...
    public PIDDP(double Kp, double Ki, double Kd, double Kdp,
            PIDSource source, PIDOutput output) {
        this(Kp, Ki, Kd, Kdp, source, output, kDefaultPeriod);
    }
    ...
    private void calculate() {
        ...
        if (enabled) {
            ...
            synchronized (this) {
                ...
                m_result = (m_P * m_error + m_I * m_totalError + m_D * dError
                        + dpTerm);
                m_prevError = m_error;
     ...
     */
    public synchronized void setPIDDP(double p, double i, double d, double dp) {
        m_P = p;
        m_I = i;
        m_D = d;
        m_DP = dp;
    ...
    /**
     * Get the Differential/Position coefficient
     * @return differential/position coefficient
     */
    public synchronized double getDP() {
        return m_DP;
    }
    ...
    /**
     * Set the Differential/Position coefficient
     */
