...
public class Aiming {
     ...
     *
     *
     * Remember that this requires the camera to be "perfectly" flat, and the
     * targets to be "perfectly" vertical. A new function will probably need to
     * be created for use on the robot. That, or we'll need to manipulate the
     * points based on camera angle.
     *
     * The points are in the following pattern:
     *
     * +y ^ | 1 2 | | 3 4 +------> +x
     *
     * @return a Point3d holding the X, Y, and Z of the target, relative to the
     * camera.
     *
     */
    ...
    /**
     * This function gets the direction the target is facing, relative to the
     * camera. It is imperfect, and half-assumes a simple orthographic
     * projection (which is not quite like real life). If it causes issues
     * (which the accuracy of this function doesn't need to be very high), we
     * can fix it later.
     *
