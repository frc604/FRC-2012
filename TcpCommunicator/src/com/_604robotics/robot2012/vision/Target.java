...
public class Target {
	 ...
	 * 
	 * x will be positive when the target appears to be right of the center of the camera.
	 * y will be positive when the target appears to be above of the center of the camera.
	 * z will always be negative (see <a href="http://en.wikipedia.org/wiki/Right-hand_rule">Wikipedia: Right-hand rule</a>).
	 * 		As the absolute value of z increases, so does the distance from the camera to the target.
	 * 
	 ...
	 * 
	 * These are interpreted as Б's to the x, y, and z values.
	 * 
	 ...
	 * 
	 * This is interpreted as a Б to the angle.
	 * 
